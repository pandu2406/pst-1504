...
export default function QueueManagementPage() {
    ...
    const handleRemindSKD = (queue: Queue) => {
        ...
        setReminderMessage(
            `Halo ${queue.visitor.name}, mohon kesediaannya untuk mengisi Survei Kebutuhan Data (SKD) 2025 BPS Kabupaten Batang Hari melalui link berikut: s.bps.go.id/1504-SKD25`
        );
